export default {
  ...
  description: {
    ...
    es: 'Los guerreros están hechos para resistir más daño de los monstruos que cualquier otra clase mediante su gran defensa a través de su equipamiento (escudos) y fuertes buffs defensivos.',
